// IMPORTANT react-spring - should be 8.0.5!
// And I removed StrictMode
...
function generateRandomizedFrames(framesObject) {
    ...
    for (let theme of themes) {
        console.log(theme);
        shuffle(framesObject[theme]["images"]);
        arrayOfFrames = framesObject[theme]["images"].map((image, index) => {
            return {
                id: index + idCounter,
                url: framesObject[theme]["images"][index],
...
let slides = generateRandomizedFrames(FRAMES);
